// Type definitions for GreenSock TweenAnimation Platform 1.15.1
...
declare class TweenAnimation {
    ...
    delay(): number;
    delay(value: number): TweenAnimation;
    duration(): number;
    duration(value: number): TweenAnimation;
    eventCallback(type: string): Function;
    eventCallback(type: string, callback: Function, params?: any[], scope?: any): TweenAnimation;
    invalidate(): TweenAnimation;
    isActive(): boolean;
    kill(vars?: Object, target?: Object): TweenAnimation;
    pause(atTime?: any, suppressEvents?: boolean): TweenAnimation;
    paused(): boolean;
    paused(value: boolean): TweenAnimation;
    play(from?: any, suppressEvents?: boolean): TweenAnimation;
    progress(): number;
    progress(value: number, supressEvents?: boolean): TweenAnimation;
    restart(includeDelay?: boolean, suppressEvents?: boolean): TweenAnimation;
    resume(from?: any, suppressEvents?: boolean): TweenAnimation;
    reverse(from?: any, suppressEvents?: boolean): TweenAnimation;
    reversed(): boolean;
    reversed(value: boolean): TweenAnimation;
    seek(time: any, suppressEvents?: boolean): TweenAnimation;
    startTime(): number;
    startTime(value: number): TweenAnimation;
    time(): number;
    time(value: number, suppressEvents?: boolean): TweenAnimation;
    timeScale(): number;
    timeScale(value: number): TweenAnimation;
    totalDuration(): number;
    totalDuration(value: number): TweenAnimation;
    totalProgress(): number;
    totalProgress(value: number): TweenAnimation;
    totalTime(): number;
    totalTime(time: number, suppressEvents?: boolean): TweenAnimation;
}

declare class SimpleTimeline extends TweenAnimation {
...
//com.greensock
declare class TweenLite extends TweenAnimation {
...
declare class TweenMax extends TweenLite {
    ...
    static allTo(target: Object[], duration: number, vars: Object): TweenMax;
...
declare var RoughEase: RoughEase;
